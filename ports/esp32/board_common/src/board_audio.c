...
static esp_codec_dev_handle_t output_dev;
static esp_codec_dev_handle_t input_dev;
...
static esp_err_t audio_i2s_init(void)
{
    ...
    std_cfg.gpio_cfg.mclk = (gpio_num_t)BOARD_PIN_I2S_MCK;
    std_cfg.gpio_cfg.bclk = (gpio_num_t)BOARD_PIN_I2S_BCK;
    std_cfg.gpio_cfg.ws = (gpio_num_t)BOARD_PIN_I2S_LRCK;
    std_cfg.gpio_cfg.dout = (gpio_num_t)BOARD_PIN_I2S_DOUT;
    std_cfg.gpio_cfg.din = (gpio_num_t)BOARD_PIN_I2S_DIN;
...
void board_audio_recording(uint8_t *data, size_t limit_size)
{
    ...
    esp_codec_dev_read(input_dev, data, limit_size);
    if (board_i2c_lock(0)) {
